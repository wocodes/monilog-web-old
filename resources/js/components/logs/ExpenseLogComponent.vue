            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">Expense Logs</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">See all your logged expenses here</span>
                    </h3>
                    ...
                    <div class="tab-content mt-5" id="myTabTables11">
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_11_1" role="tabpanel" aria-labelledby="kt_tab_pane_11_1">
                            ...
                            <div class="table-responsive">
                                <table class="table table-head-custom table-head-bg table-borderless table-vertical-centerr">
                                    <thead>
                                        <tr class="text-left text-uppercase">
                                            ...
                                            <th class="min-w-110px">Category</th>
                                            <th class="min-w-150px">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <tr v-if="currentMonthsLogs" v-for="log in currentMonthsLogs">
                                        <td class="pl-0 py-4">
                                        ...
                                        <td class="pl-0">
                                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ log.title }}</a>
                                            <div>
                                                <span class="font-weight-lighter">{{ log.date_logged | formatShortWordDate }}</span>
                                            </div>
                                        </td>
                                        <td class="text-right">
                                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ '&#8358;' + log.amount.toLocaleString() }}</span>
                                        </td>
                                        <td class="text-left">
                                    ...
                                    <tr class="text-left text-uppercase">
                                        <td class="w-40px"></td>
                                        <td class="min-w-200px font-weight-bolder font-size-lg">TOTAL AMOUNT</td>
                                        <td class="min-w-100px font-weight-bolder font-size-lg">&#8358; {{ currentMonthsTotalLog.toLocaleString() }}</td>
                                        <td class="min-w-125px"></td>
                                        <td class="min-w-110px"></td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless table-vertical-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <span class="label label-lg label-light-success label-inline">Data</span>
                                        </td>
                                        <td class="text-right pr-0">
                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
        																				<span class="svg-icon svg-icon-md svg-icon-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <span class="label label-lg label-light-danger label-inline">Others</span>
                                        </td>
                                        <td class="text-right pr-0">
                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
        																				<span class="svg-icon svg-icon-md svg-icon-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <span class="label label-lg label-light-primary label-inline">Others</span>
                                        </td>
                                        <td class="text-right pr-0">
                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
        																				<span class="svg-icon svg-icon-md svg-icon-primary">
                        ...
                        <div class="tab-pane fade show active" id="kt_tab_pane_11_3" role="tabpanel" aria-labelledby="kt_tab_pane_11_3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                    ...
                                    <tbody>
                                        <tr v-for="log in todaysLogs" class="log-list">
                                            <td class="pl-0 py-4">
                                                <div class="symbol symbol-50 symbol-light mr-1">
                                                                                            <span class="symbol-label">
                                                                                                <img src="/assets/media/svg/misc/006-plurk.svg" class="h-50 align-self-center" alt="" />
                                    ...
                                    <tfoot>
                                        <tr class="text-left text-uppercase">
                                            <td class="w-40px"></td>
                                            <td class="min-w-200px font-weight-bolder font-size-lg">TOTAL AMOUNT</td>
                                            <td class="min-w-100px font-weight-bolder font-size-lg">&#8358; {{ todaysTotalLog.toLocaleString() }}</td>
                                            <td class="min-w-125px"></td>
                                            <td class="min-w-110px"></td>
                                            <td class="min-w-150px"></td>
                                        </tr>
    ...
    export default {
        ...
        created() {
            ...
            .then(result => {
                ...
                console.log('data',this.currentMonthsLogs);
